...
{expect} = require 'chai'
EnqueueJobsForWebhooksUnregisterReceived = require '../'

describe 'EnqueueJobsForWebhooksUnregisterReceived', ->
  beforeEach (done) ->
    @datastore = new Datastore
      database: mongojs('meshblu-core-task-enqueue-jobs-for-webhooks-unregister-received')
      collection: 'devices'
  ...
  beforeEach ->
    client = new RedisNS 'ns', redis.createClient(@redisKey)
    @sut = new EnqueueJobsForWebhooksUnregisterReceived {
      datastore:         @datastore
